...
\usepackage{graphicx}           % Картиночки
\graphicspath{ {./images/} }    % Директория с картиночками
...
\usepackage[strings]{underscore}    % Поддержка нижнего подчёркивания в bib
...
\begin{document}
    ...
    \include{Главы/Аналоги}
    \include{Главы/Проектирование}
    \include{Главы/Разработка}
